...
public class Commune {
    ...
    @NotNull
    @NotBlank
    //5 chiffres (2ème caractère peut être A ou B)
    ...
    //Taille max = 50
    //majuscules, minuscules, tirets, apostrophes, espaces et éventuellement terminé par 1 ou 2 chiffres
    @Size(max=50)
    @NotBlank(message = "ne doit pas être nul")
    ...
    //Latitude et longitude sont facultatives
    //Intervalles de valeurs possibles pour latitude et longitude?
    //Messages par défaut pour latitude et longitude
